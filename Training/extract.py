...
# %%
DATASET_DIR = r"C:\Users\ACER NITRO\FSL\Training\Videos"   # root with Videos sources
REPORT_CSV  = r"C:\Users\ACER NITRO\FSL\Training\video_audit.csv"
...
# %%
DATASET_DIR   = r"C:\Users\ACER NITRO\FSL\Training\Videos"
VIDEO_EXTS    = (".mp4",".avi",".mov",".mkv",".m4v",".webm",".mpg")
SAMPLE_FRAMES = 12
HASH_THUMB    = (64, 36)
...
# %%
DATASET_DIR = r"C:\Users\ACER NITRO\FSL\Training\Videos"    # per-class folders
OUTPUT_DIR  = r"C:\Users\ACER NITRO\FSL\Training\KEYPOINTS" # per-video .npy
...
SEQUENCE_LENGTH = 25  # frames per sequence
APPEND_FLAGS    = True  
...
files = glob.glob(r"C:\Users\ACER NITRO\FSL\Training\KEYPOINTS\**\*.npy", recursive=True)
...
# %%
DATASET_DIR = Path(r"C:\Users\ACER NITRO\FSL\Training\Videos")     # raw videos per class
NPY_DIR     = Path(r"C:\Users\ACER NITRO\FSL\Training\KEYPOINTS")  # extracted npy per class
VIZ_DIR     = Path(r"C:\Users\ACER NITRO\FSL\Training\VIZ")        # output visualizations
